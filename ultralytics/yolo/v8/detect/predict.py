...
line = [(100, 500), (1050, 500)] # die gesetzte line for counting

# die Idee ist es einfach bei jedem hochzählen des Counters die Informationen des Tracklets zu exportieren
...
def draw_boxes(img, bbox, names,object_id, identities=None, offset=(0, 0)):
    ...
    for key in list(data_deque):
      if key not in identities:
        ...
        #img2 = img.crop((200, 330, 730, 606)) , Punkt 1(x,y) Punkt 2(x,y)
        #img2.save("img2.jpg")
        # kann ich ja aus bbox auslesen?
